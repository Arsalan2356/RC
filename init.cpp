...
void Board::init(std::string &fen) {
	...
	if ((v[2].find("K") != std::string::npos)) castle_rights |= wk;
	if ((v[2].find("Q") != std::string::npos)) castle_rights |= wq;
	if ((v[2].find("k") != std::string::npos)) castle_rights |= bk;
	if ((v[2].find("q") != std::string::npos)) castle_rights |= bq;
